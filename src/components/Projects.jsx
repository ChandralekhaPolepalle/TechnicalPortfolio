...
const Projects = () => {
  return (
    <div className="border-b border-neutral-900 pb-4">
        <h2 className="my-20 text-center text-4xl font-thin tracking-widest">
            ...
            { PROJECTS.map((project, index) => (
                <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                    ...
                    <div className="w-full max-w-xl lg:w-3/4">
                        <h6 className="mb-2 tracking-wide">{project.title}</h6>
                        <p className="mb-4 text-neutral-400 text-justify text-sm">
